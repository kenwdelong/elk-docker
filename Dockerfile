...
RUN curl 'https://download.maxmind.com/app/geoip_download?edition_id=GeoLite2-City&license_key=${GEOLITE_LICENSE_KEY}&suffix=tar.gz' -o /tmp/GeoLiteCity2.tar.gz
