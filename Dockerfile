...
RUN curl -L -u ${GEOLITE_ACCOUNT_KEY}:${GEOLITE_LICENSE_KEY} "https://download.maxmind.com/geoip/databases/GeoLite2-City/download?suffix=tar.gz" -o /tmp/GeoLiteCity.tar.gz &&\
